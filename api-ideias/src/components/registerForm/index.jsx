...
function RegisterForm() {
    ...
    return (
        <div className="register-form-box">
            <form ref={registerForm} onSubmit={handleSubmit} className="form-register-container">
                ...
                <div className="input-register">
                    ...
                    <div className='show-password'>
                        <img src={eye} alt="mostra" onClick={togglePasswordVisibility} className='toggle-password'/>
                        <p>mostra senha</p>
